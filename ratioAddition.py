...
class Factor:
    ...
    def __str__(self):
        return f'factors of {self.num}: {self.factors}'
...
class Ratio:
    ...
    def add_ratio(ratio1, ratio2):   #static method, but should it be
        ...
        num1, denom1 = eval(ratio1)
        num2, denom2 = eval(ratio2)
    ...
    def __init__(self, num, denom):
        ...
        numerator_list = eval(repr(Factor(num)))   #evaluate given Factors to get lists of prime factors
        denominator_list = eval(repr(Factor(denom)))
...
if '__main__' == __name__:
    ...
    print(Ratio.add_ratio(repr(six_sevenths), repr(ten_elevenths)))
